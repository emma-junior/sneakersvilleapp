...
const PaystackCheckoutBtn = () => {
  ...
  return (
    <>
      {User ? <Link to="/pay-with-paystack"><button className='paystack-btn'>Checkout With Paystack</button></Link>:
        <Link to="/login"><button className='paystack-btn'>Checkout With Paystack</button></Link>}
    </>
